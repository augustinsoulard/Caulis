    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <se:PolygonSymbolizer>
            <se:Fill>
              <se:SvgParameter name="fill">#12403C</se:SvgParameter>
            </se:Fill>
          </se:PolygonSymbolizer>
        </se:Rule>
        <se:Rule>
        ...
        <se:Rule>
          <se:Name>Autres habitats de rang différent de 1 (non représentés sur la carte)</se:Name>
          <se:Description>
            <se:Title>Autres habitats de rang différent de 1 (non représentés sur la carte)</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
